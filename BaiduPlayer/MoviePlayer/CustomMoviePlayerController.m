...
-(IBAction)playClick:(id)sender{
    ...
    if ([playButton tag]==2) {
        ...
        [moviePlayeView.player pause];
        [playButton setTag:1];
        [playButton setImage:[UIImage imageNamed:@"ic_play_media.png"] forState:UIControlStateNormal];
    }else{
        //从暂停状态进入播放
        [moviePlayeView.player play];
        [playButton setTag:2];
        [playButton setImage:[UIImage imageNamed:@"ic_stop_media.png"] forState:UIControlStateNormal];
    }
}
